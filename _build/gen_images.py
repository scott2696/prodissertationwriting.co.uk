...
PLUM = (10, 38, 34, 255)      # --plum
PLUM3 = (28, 107, 92, 255)    # --plum-4
CITRINE = (226, 163, 60, 255) # --citrine
...
d.text((104, 30), "PoundPlay", font=font(31), fill=WHITE)
...
d.text((186, 82), "PoundPlay", font=font(52), fill=WHITE)
...
d.text((70, 546), "prodissertationwriting.co.uk   \u00b7   18+   \u00b7   Gamble responsibly   \u00b7   BeGambleAware.org",
       font=font(25, False), fill=MUT)
og.convert("RGB").save(os.path.join(IMG, "og-poundplay.jpg"), quality=88)
