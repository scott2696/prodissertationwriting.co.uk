#!/usr/bin/env python3
"""PoundPlay (prodissertationwriting.co.uk) builder — the "priced in pounds" template.
...
DOMAIN = "https://prodissertationwriting.co.uk"
SITE = "PoundPlay"
BRAND_WORD = "PoundPlay"
TAGLINE = "UK casino &amp; betting reviews, priced in pounds"
UPDATED = "2026-09-13"
UPDATED_HUMAN = "13/09/2026"
UPDATED_LONG = "13 September 2026"
NEXT_REVIEW_LONG = "11 October 2026"
...
AUTHORS = {
 "james": dict(
   ...
   bio="I worked six years in card acquiring and chargeback operations in "
       "Manchester, most of it on gambling merchant accounts, which is where I "
       "learned how differently a cashier behaves depending on who is running "
       "it. I open every account on this site in my own name, fund it with my "
...
BRAND_TAG = "Every offer priced &middot; every payout timed"
...
def lead_html(fm, lede, extra=None):
    ...
    lockup = ""
    if home:
        lockup = ('<p class="wordmark">PoundPlay<span class="dot">.</span></p>'
...
FOOT_BLURB = ("Two people in Manchester, a spreadsheet and a lot of receipts. Every casino on this "
              "site was joined with our own money, played with our own money and withdrawn from with "
              "our own money, and every welcome offer is priced from the operator's own terms. Where "
              "a test is unfinished, the page says so rather than guessing.")
...
def schema_blocks(fm, body, url):
    ...
    g = people + [
         {"@type": page_type,
          ...
          "primaryImageOfPage": {"@type": "ImageObject", "@id": url + "#primaryimage",
                                 "url": DOMAIN + "/images/og-poundplay.jpg",
    ...
    if fm.get("dataset"):
        ...
        g.append({"@type": "Dataset", "@id": url + "#dataset",
                  "name": "PoundPlay withdrawal ledger",
                  ...
                  "spatialCoverage": {"@type": "Place", "name": "Manchester, United Kingdom"},
...
<meta property="og:image" content="%s/images/og-poundplay.jpg">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
<meta property="og:image:alt" content="PoundPlay - independent UK casino reviews">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="%s">
<meta name="twitter:description" content="%s">
<meta name="twitter:image" content="%s/images/og-poundplay.jpg">
